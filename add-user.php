...
<head>
        ...
        <!--end::Fonts -->
            ...
            <!--begin::Page Custom Styles(used by this page) --> 
                             <link href="assets/css/demo2/pages/general/wizard/wizard-4.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" href="assets/media/logos/cop-kad-pentlogo.jpeg" />
    </head>
    <!-- end::Head -->
...
<div class="kt-notification">
    ...
    <div class="kt-notification__custom kt-space-between">
        <a href="../../../index.html" target="_blank" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>

        <a href="../../user/admin-dashboard.html" target="_blank" class="btn btn-clean btn-sm btn-bold">Upgrade Plan</a>
    </div>
</div>
<!--end: Navigation -->		</div>
	</div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <select class="form-control" name="gender">
                                                            ...
                                                            <option value="msa">Others</option>
                                                            </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Other Contact</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-phone"></i></span></div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control" value="" placeholder="" aria-describedby="basic-addon1">
                                                        </div> 
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Username</label><!--autogenerate by the system-->
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-at"></i></span></div>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Password</label><!--auto generate by the system-->
                                                    <div class="col-lg-9 col-xl-9">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"></div>
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="kt-checkbox-inline">
                                                            <label class="kt-checkbox">
                                                                <input type="checkbox" checked=""> Facial Recognition
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-checkbox">
                                                                <input type="checkbox" checked=""> Fingerprint
                                                                <span></span>
                                                            </label>
                                                            <label class="kt-checkbox">
                                                                <input type="checkbox"> Card Swipe
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </div>
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="kt-wizard-v4__form">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="address1" placeholder="Address Line 1" value=""><!--this textbox cannot be left empty-->
										<span class="form-text text-muted">Please enter your Address.</span>
									</div>
									<div class="form-group">
										<label>Address Line 2</label>
										<input type="text" class="form-control" name="address2" placeholder="Address Line 2" value="">
									...
									<div class="row">
										<div class="col-xl-6">
											<div class="form-group">
												...
												<span class="form-text text-muted">This textbox cannot be left empty</span>
											</div>
										</div>
										<div class="col-xl-6">
											<div class="form-group">
												<label>City</label>
												<input type="text" class="form-control" name="state" placeholder="City" value="">
												<span class="form-text text-muted">This textbox cannot be left empty</span>
											</div>
										</div>
									</div>
					...
					<div class="col-lg-4">
						<div  class="kt-footer__section">
							...
							<div class="kt-footer__content">
                                    This application  is developed for the Church of Pentecost
                                    Kwadaso Agric District. The three Assemblies:
                                    Emmanuel, Glory and Hope Assemblies
							</div>
						</div>
					</div>
					<div class="col-lg-4">
							...
							<div class="kt-footer__content">
								<div class="kt-footer__nav">
									<div class="kt-footer__nav-section">
                                            ...
                                            <a href="https://www.thecophq.org">The Church of Pentecost</a>
									</div>
									<div class="kt-footer__nav-section">
			...
			<div class="kt-footer__wrapper">
				<div class="kt-footer__logo">
					...
					<div class="kt-footer__copyright">
						2019&nbsp;&copy;&nbsp;  
						<a href="http://epawebsgh" target="_blank">Epaweb Solutions - Ghana +233 570 364 383</a>
					</div>
				</div>				 
				<div class="kt-footer__menu">
                        <a href="http://epawebsgh.com/request" target="_blank">Request</a>
                        <a href="http://epawebsgh.com/about-us" target="_blank">About Us</a>
                        <a href="http://epawebsgh.com/" target="_blank">Epawebs Solutions</a>
				</div>	
			</div>
		</div>	
	</div> 
	...
	<div class="kt-demo-panel__body">
        <div class="kt-demo-panel__item ">
                    ...
                    <div class="kt-demo-panel__item-preview">
                        ...
                        <div class="kt-demo-panel__item-preview-overlay">
                            <a href="add-user.html" class="btn btn-brand btn-elevate " target="_blank">Default</a>
                            <a href="../../../rtl/custom/apps/user/add-user.html" class="btn btn-light btn-elevate" target="_blank">RTL Version</a>
                        </div>
                    </div>                    
...
<!--ENd:: Chat-->
    	...
    	<!--begin::Global Theme Bundle(used by all pages) -->
            ...
            <!--begin::Page Scripts(used by this page) -->
                            <script src="assets/js/demo2/pages/custom/apps/user/add-user.js" type="text/javascript"></script>
                        <!--end::Page Scripts -->
            </body>
    <!-- end::Body -->
